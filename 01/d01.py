...
print("Checking number of depth increases in test data, secondd method: ", count_depth_increases(test_measurements_adjusted) == 5)
print('And now with functional approach...')
print("Checking number of depth increases in test data: ", count_depth_increases_functional(test_measurements, 1) == 7)
print("Checking number of depth increases in test data, secondd method: ", count_depth_increases_functional(test_measurements, 3) == 5)
print('---------------------')
...
with open('inp', mode='r') as inp:
    ...
    print("Checking number of depth increases in test data, secondd method: ", count_depth_increases_functional(measurements, 3))
