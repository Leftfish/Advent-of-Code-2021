...
print('Cheap crabs:', int(crabs_naive(crabs, lambda a, b: abs(b - a))) == 37)
print('Cheap crabs (non naive):', int(crabs_by_median(crabs)) == 37)
print('Expensive crabs:', (int(crabs_naive(crabs, sum_range)) == 168))
print('---------------------')
...
with open('inp', mode='r') as inp:
    raw_data = inp.read()
    crabs = sorted(list(map(int, raw_data.split(','))))
    print('Cheap crabs:', int(crabs_naive(crabs, lambda a, b: abs(b - a))))
    print('Cheap crabs (non naive):', int(crabs_by_median(crabs)))
    print('Expensive crabs:', (int(crabs_naive(crabs, sum_range))))
